...
### Live Scoreboard
- A sidebar shows each player their team's remaining time, their own unbanked coins, their team's
  banked coins, and the standings across every team, refreshed once a second.
- A boss bar tracks the team's sand draining away, turning yellow under a minute and red under
  thirty seconds.
...
- **GameScoreboardManager**: Drives the live sidebar and per-team boss bar while a round runs; `ScoreboardLayout` builds their text.
